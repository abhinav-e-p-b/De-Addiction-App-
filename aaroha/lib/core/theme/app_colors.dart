...
class AarohaColors {
  ...
  // ── Surface hierarchy ─────────────────────────────────────
  // "Stacked fine papers" — base → secondary → raised
  static const Color surface = Color(0xFFFCF9F5);          // Base
  ...
  static const Color surfaceContainerLow = Color(0xFFF6F3F0);   // Secondary
  static const Color surfaceContainer = Color(0xFFF0EDEA);
  static const Color surfaceContainerHigh = Color(0xFFEAE8E4);
  static const Color surfaceContainerHighest = Color(0xFFE5E2DF); // Raised
  ...
  // ── Gradient ─────────────────────────────────────────────
  /// Signature CTA — 135° primary → primaryContainer
  ...
  // ── Semantic helpers ─────────────────────────────────────
  static const Color mintSurface = Color(0xFFE1F5EE); // Chat AI, accent cards
}
